...
Suite.prototype = {
  ...
  updateContext: function( context ) {
    ...
    // Suite / Test hooks
    global.beforeAll = global.setup = context.setup.bind( context )
    global.beforeEach = context.beforeEach.bind( context )
    global.afterEach = context.afterEach.bind( context )
    global.afterAll = global.teardown = context.teardown.bind( context )
    
    // Suite / Test definition
    global.describe = global.suite = context.addSuite.bind( context )
    global.describe.skip = context.skipSuite.bind( context )
    global.it = global.test = this.skip === true ?
